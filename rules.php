...
<div class="contentsection contemplete clear">
	<div class="maincontent clear">
		<div class="about">
			<h2>Rules and Regulations for the BAUST Halls</h2>
			<img src="images/post1.jpg" alt="MyImage"/>
		<p>
The rules are intended to benefit all residents.However, the expectations of you outlined in the rules should not be seen as an exhaustive  list.  In  becoming a resident,you become a member of the residential  community  and  accept the responsibilities and obligations of being a good neighbour and citizen, whether or not they are detailed in the rules.    
		</p>
		<p>
				If you fail to comply with these rules and any updated or variation of them which is notified by management at your residence,it will constitute a failure by you to comply with the provisions of your Residential Agreement and may lead to disciplinary action againt you, including termination of your right to reside in the residence
		</p>
		<p>
				You must at all times comply with these residential rules, the Policies of the  University  of  Auckland  and  all  New  Zealand  law.  This  includes additional rules and regulations implemented by the Area Manager and the  members  of  the  Accommodation  Management  team  and/or  any duly authorised agent of the University.   
		</p>
